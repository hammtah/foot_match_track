...
### Home — latest results & upcoming hero

![Home page](public/images/foot_home.png)

### Upcoming matches & countdown

![Upcoming matches](public/images/foot_upcoming.png)

### Match details

![Match details](public/images/match_details.png)

### Standings 

![Classement](public/images/classement.png)

### Admin dashboard

![Admin dashboard](public/images/foot_admin.png)

## Requirements

- PHP 8.0+ with extensions: `pdo_sqlite`, `sqlite3`
- A web browser
...
Open [http://localhost:8000](http://localhost:8000) — you are redirected to the login page.
...
| Email | Password | Role |
|-------|----------|------|
| `alice@example.com` | `1` | General admin (`g`) |
| `thomas@example.com` | `motdepasse3` | Tournament admin (`t`) |
...
| URL | Description |
|-----|-------------|
| `/auth/auth.php` | Login / sign up |
| `/home/home.php` | Home — latest & upcoming matches, follow teams |
| `/match/match-details.php?match_id=30` | Match details, stats, comments, poll |
| `/admin-general/index.php` | General admin (teams, players, tournaments, …) |
| `/admin-tournoi/admin-tournaments.php` | Tournament admin (matches, lineups, goals) |
| `/teams/team-info.php?idTeam=17` | Team profile |
...
# Restart the server — DB is recreated and re-seeded
```

If all match dates are in the past, `ensureUpcomingMatches()` in `database/init.php` automatically schedules demo fixtures for the next days so the home page hero and “Coming Match” tab stay populated.
